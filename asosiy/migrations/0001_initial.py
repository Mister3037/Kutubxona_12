    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('daraja', models.CharField(choices=[('Magistr', 'Magistr'), ('Bakalavr', 'Bakalavr')], max_length=50)),
                ('fan_fk', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='asosiy.fan')),
            ],
        ),
        migrations.AddField(
            model_name='fan',
